...
This release collects work completed since v2.3.0-beta: improvements to the recommendation engine, playback/download robustness, UI polish for the player and mini-player, and multiple stability fixes targeting queue and streaming reliability.
...
- This release also includes numerous UI polish changes and small UX improvements listed in the full release note below. See the full changelog entry in `CHANGELOG.md` for a concise summary.
